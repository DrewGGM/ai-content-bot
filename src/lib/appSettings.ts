...
export const APP_SETTINGS: AppSettingDef[] = [
  ...
  // --- Activar/desactivar proveedores (aunque su key esté configurada) ---
  // Sirven para apagar un servicio de pago sin borrar sus credenciales: el planner deja de elegir
  // los formatos que dependen de él y el scheduler cae a lo disponible (design).
  {
    key: "ENABLE_FAL",
    label: "Usar fal (imágenes IA + video + avatar)",
    type: "bool",
    options: [],
    default: "true",
    help: "Apágalo para NO gastar en fal aunque tengas FAL_KEY: se desactivan las imágenes por fal, el video b-roll (reel) y el avatar OmniHuman. El bot sigue con los formatos por código (design, deck, motion) y otros proveedores de imagen si los configuras.",
    group: "Proveedores (activar/desactivar)",
  },
  {
    key: "ENABLE_VIDEO",
    label: "Usar video b-roll (image-to-video)",
    type: "bool",
    options: [],
    default: "true",
    help: "Apágalo para desactivar el reel de video b-roll (Kling/Veo vía fal) sin tocar las imágenes. Los videos por código (motion, Remotion) siguen disponibles.",
    group: "Proveedores (activar/desactivar)",
  },
  {
    key: "ENABLE_VOICE",
    label: "Usar voz (ElevenLabs)",
    type: "bool",
    options: [],
    default: "true",
    help: "Apágalo para no generar voz aunque tengas ELEVENLABS_API_KEY: los videos motion caen a música/silencio y el reel deja de estar disponible.",
    group: "Proveedores (activar/desactivar)",
  },
  {
    key: "ENABLE_HEYGEN",
    label: "Usar avatar UGC (HeyGen)",
    type: "bool",
    options: [],
    default: "true",
    help: "Apágalo para desactivar el formato UGC (avatar hablando) aunque tengas las credenciales de HeyGen.",
    group: "Proveedores (activar/desactivar)",
  },
  {
    key: "ENABLE_ADS",
    label: "Módulo de campañas de ads (Meta)",
    type: "bool",
    options: [],
    default: "true",
    help: "Apágalo para ocultar y bloquear el módulo de campañas de ads del panel (no crea ni toca campañas en Meta).",
    group: "Proveedores (activar/desactivar)",
  },
  {
    key: "MAX_HASHTAGS",
